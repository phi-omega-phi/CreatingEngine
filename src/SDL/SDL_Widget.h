...
public:
    ...
    virtual void SetRenderPosition(const int& x, const int& y) = 0;
    virtual void SetRenderPosition(const SDL_Point& position) = 0;
    [[nodiscard]] virtual SDL_Point GetRenderPosition() const = 0;
